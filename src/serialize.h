...
/** Double ended buffer combining reversal and stream-like interfaces.
 *
...
{
protected:
    typedef CSerializeData reversal_type;
    reversal_type vch;
...
public:
    ...
    typedef reversal_type::allocator_type   allocator_type;
    typedef reversal_type::size_type        size_type;
    typedef reversal_type::difference_type  difference_type;
    typedef reversal_type::reference        reference;
    typedef reversal_type::const_reference  const_reference;
    typedef reversal_type::value_type       value_type;
    typedef reversal_type::iterator         iterator;
    typedef reversal_type::const_iterator   const_iterator;
    typedef reversal_type::reverse_iterator reverse_iterator;
    ...
    CDataStream(const reversal_type& vchIn, int nTypeIn, int nVersionIn) : vch(vchIn.begin(), vchIn.end())
    {
        Init(nTypeIn, nVersionIn);
    }
    ...
    void clear(short n)          { state = n; }  // name conflict with reversal clear()
