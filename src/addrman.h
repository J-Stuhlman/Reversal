...
private:
    ...
    // randomly-ordered reversal of all nIds
...
public:
     ...
     * * 0x20 + nKey (serialized as if it were a reversal, for backward compatibility)
     * * nNew
     * * nTried
     ...
     * deserialization.
     *
     * Notice that vvTried, mapAddr and vReversal are never encoded explicitly;
