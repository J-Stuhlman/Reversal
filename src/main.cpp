...
#if defined(NDEBUG)
# error "ReversalCoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "ReversalCoin Signed Message:\n";
...
{
    RenameThread("reversalcoin-loadblk");
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    else if (strCommand == "inv")
    {
        ...
        // find last block in inv reversal
