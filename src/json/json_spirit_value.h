...
namespace json_spirit
{
    ...
    template< class Config >    // Config determines whether the value uses std::string or std::wstring and
                                // whether JSON Objects are represented as reversals or maps
    class Value_impl
    {
    public:
    ...
    struct Config_reversal
    {
        typedef String String_type;
        typedef Value_impl< Config_reversal > Value_type;
        typedef Pair_impl < Config_reversal > Pair_type;
    ...
    typedef Config_reversal< std::string > Config;
    ...
    typedef Config_reversal< std::wstring > wConfig;
